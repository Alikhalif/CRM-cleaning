...
-- « Déménagement partiel de bureaux ». À chiffrer (0 €), forfait, TVA 20 %.
...
from activities a
join (values
  ('Déménagement partiel de bureaux', 'forfait', 0, 20, $D$Prestation à réaliser :
Réalisation d'un déménagement professionnel partiel de bureaux comprenant la manutention, le chargement, le transport sécurisé et le déchargement du mobilier, des équipements, du matériel informatique, des archives, des fournitures et des autres biens expressément désignés par le client vers les nouveaux locaux.
...
- Chargement organisé des postes de travail, du mobilier, des équipements informatiques, des archives et des fournitures concernés par la prestation.
