...
-- « Déménagement partiel d'archives et de matériel professionnel ». À chiffrer (0 €), forfait, TVA 20 %.
...
from activities a
join (values
  ('Déménagement partiel d''archives et de matériel professionnel', 'forfait', 0, 20, $D$Prestation à réaliser :
Réalisation d'un déménagement professionnel partiel d'archives et de matériel professionnel comprenant la manutention, le chargement, le transport sécurisé et le déchargement des archives, documents, dossiers, équipements professionnels, matériel informatique, fournitures, mobilier associé et autres biens expressément désignés par le client vers le nouveau site.

Prestations incluses :
- Manutention des archives, documents et équipements professionnels sélectionnés pour le déménagement.
- Protection des archives, du matériel et du mobilier durant les opérations de manutention et de transport.
- Chargement organisé des archives, des équipements, du mobilier et des fournitures concernés par la prestation.
